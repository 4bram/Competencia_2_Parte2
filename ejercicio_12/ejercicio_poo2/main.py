...
class Main:
    ...
    def ejecutar(self):
        ruta = input("Escribe la ruta del archivo (Enter para escribir la expresion): ")

        # Si no se ingreso ruta, pedimos la expresion directamente por terminal
        if ruta.strip() == "":

            # Mostramos el prompt "?" esperando la expresion
            codigo = input("? ")
        ...
        # Si se ingreso ruta, seguimos el flujo normal con archivo
